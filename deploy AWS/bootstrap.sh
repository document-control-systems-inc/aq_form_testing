...
then
	...
	sudo mkdir -p /opt/ecm/formsTemplate
	sudo chown -R tomcat7:tomcat7 /opt/ecm/formsTemplate
...
sudo unzip provisioning/web/portal.zip -d /var/lib/tomcat7/webapps/ROOT/
