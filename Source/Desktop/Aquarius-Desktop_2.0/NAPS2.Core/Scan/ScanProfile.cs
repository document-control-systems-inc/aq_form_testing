...
namespace NAPS2.Scan
{
    ...
    public class ScanProfile
    {
        ...
        public string AquariusProfile { get; set; }

        public string AquariusIdParent { get; set; }

        public string AquariusNameParent { get; set; }

        public string AquariusDocumentClass { get; set; }

        public string AquariusDomain { get; set; }
    }
