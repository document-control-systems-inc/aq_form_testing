...
namespace NAPS2.WinForms
{
    partial class FTreeView : FormBase
    {
        ...
        private void LoadTreeview() {
            String json = AquariusUtils.getTree(ResultadoLogin.token);
        ...
        private void Loadcombo() {
            ...
            String json = AquariusUtils.getDocumentClass(ResultadoLogin.token);
        ...
        private void LoadDomain() {
            String json = AquariusUtils.getDomain(ResultadoLogin.token);
