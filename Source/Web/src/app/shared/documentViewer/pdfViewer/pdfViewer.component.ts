...
export class PdfComponent implements OnChanges{
	...
	constructor(private _pdfViewerServices:PdfViewerServices, private translate: TranslateService){	
		this.token = localStorage.getItem('token');
		this.zoom = 1;
		this.pdfViewerClass = "col-xs-12 col-sm-9 col-lg-10 text-left viewer";
