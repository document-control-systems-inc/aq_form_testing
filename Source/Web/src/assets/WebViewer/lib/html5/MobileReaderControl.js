...
(function(exports) {
    ...
    exports.ReaderControl = function(options) {
        ...
        me.isCopySupported = (window.utils.ie || window.chrome || this.isIOS) ? true : false;
    ...
    exports.ReaderControl.prototype = {
        ...
        getChangeResponse: function(changes) {
            ...
            var added_length = added.length;

            var i;
            for (i = 0; i < added_length; ++i) {
                current = added[i];
            ...
            var removed_length = removed.length;
            ...
            var contentChanged_length = contentChanged.length;
            for (i = 0; i < contentChanged_length; ++i) {
