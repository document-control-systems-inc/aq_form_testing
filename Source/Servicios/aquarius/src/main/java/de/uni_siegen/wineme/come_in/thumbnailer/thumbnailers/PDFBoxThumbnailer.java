...
public class PDFBoxThumbnailer extends AbstractThumbnailer {
    ...
    /*     */   public BufferedImage convertToImage(PDPage page, int imageType, int thumbWidth, int thumbHeight)
    /*     */     throws IOException
    /*     */   {
    ...
    /* 709 */     float heightPt = mBox.getHeight();
    			  if (widthPt > heightPt) {
    					...
    					float proportion = heightPt/widthPt;
    					Float auxthumbHeight = thumbWidth * proportion;
    					thumbHeight = auxthumbHeight.intValue();
    				} else {
    					float proportion = heightPt/widthPt;
    					Float auxthumbHeight = thumbWidth * proportion;
    					thumbHeight = auxthumbHeight.intValue();
